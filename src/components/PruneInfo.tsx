...
const PruneInfo = () => {
  return (
    <div className="flex items-center justify-center min-h-[80vh] bg-[#18183B] text-white p-4">
      <div className="max-w-6xl w-full  flex flex-col md:flex-row  gap-12">
        {/* Left Column */}
        <div className="flex-1">
          <h1 className="text-3xl md:text-5xl font-mono italic mb-8">What is Prune?</h1>
        ...
        {/* Right Column */}
        <div className="flex-1">
          <p className="text-lg lg:text-xl font-main mb-6">Since starting our work in 2023, we have:</p>
          
          <div className="mb-8">
            <h2 className="lg:text-2xl font-bold uppercase tracking-wide">Stopped Proliferation</h2>
            <p className="lg:text-5xl text-teal-400 font-semibold my-2">300,000</p>
