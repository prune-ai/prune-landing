        ...
        <div className="flex flex-col md:flex-row gap-8 justify-between items-start">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="https://x.com/prune_ai" aria-label="Twitter">
                <div className="text-white hover:text-gray-300 transition duration-300">
              ...
              <Link href="https://www.instagram.com/prune_co/" aria-label="Instagram">
                <div className="text-white hover:text-gray-300 transition duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-2 md:gap-2">
            <div>
              <Link href="https://phoenixpitchdeck.webflow.io/ ">
            ...
            <div>
              <Link href="https://pruneai.substack.com/">
